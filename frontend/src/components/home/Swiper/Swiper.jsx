...
const VideoSwiper = () => {
  ...
  const slides = [
    ...
    {
      video: "./videos/kangroo.mp4",
      title: "Hop with Kangaroos",
      text: "Experience the Australian Outback and meet our friendly kangaroos.",
    },
    {
        ...
        {slides.map((slide, index) => (
          <SwiperSlide key={index} className="relative">
            ...
            <div className="relative z-10 flex flex-col justify-center items-center h-full text-center text-white px-6">
              ...
              <p
                className="text-base md:text-xl mb-8 max-w-2xl drop-shadow-lg"
                data-aos="fade-up"
                data-aos-delay="300"
              >
                {slide.text}
              ...
              >
                ...
                <a
                  href="#explore"
                  className="bg-white text-black flex items-center gap-2 px-6 py-3 rounded-lg shadow-lg hover:bg-gray-200 transition text-sm md:text-lg"
                >
